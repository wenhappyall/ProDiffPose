    ...
    def load_trainset(self):
        ...
        for i in range(len(self.trainset)):
            if self.task == 'poseseg':
                ...
                train_dataset.append(COCODataset(True, self.data_folder, self.trainset[i], self.model, self.occlusions, self.generator))
            else:
    ...
    def load_testset(self):
        ...
        for i in range(len(self.testset)):
            if self.task == 'poseseg':
                ...
                test_dataset.append(COCODataset(False, self.data_folder, self.testset[i], self.model, self.occlusions, self.generator))
            else:
