...
class PoseNet(nn.Module):
    def __init__(self):
        ...
        self.num_joints = 17
        self.conv0_0 = nn.Conv2d(in_channels=21, out_channels=21, kernel_size=3, stride=2, padding=1, dilation=1)
        self.conv0_1 = nn.Conv2d(in_channels=21, out_channels=21, kernel_size=3, stride=2, padding=2, dilation=2)
        self.conv0_2 = nn.Conv2d(in_channels=21, out_channels=21, kernel_size=3, stride=2, padding=5, dilation=5)
        ...
        self.block5 = nn.Sequential(maskBasicBlock(512 + self.num_joints, 256),maskBasicBlock(256, 64))
...
class posenet(nn.Module):
    ...
    def forward(self, crop):
        h0, h1, h2, h3, heat = self.posenet(crop)
